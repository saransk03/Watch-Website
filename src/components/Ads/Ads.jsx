        ...
        <div className="2xl:container mx-auto py-4">
            <div className="w-[80%] mx-auto grid grid-cols-1">
                <div className="flex justify-center items-center gap-4">
                    ...
                    <div className="bg-gray-400 w-[600px] flex  justify-around items-center h-[300px] rounded-[20px]">
                      <div className="flex flex-col pl-[4rem]">
                        <h1 className="font-keania text-black text-[55px] font-[800] leading-[48px]">New Arrival</h1>
                        <p className=" font-museo text-black text-[15px] font-[800] py-2">
