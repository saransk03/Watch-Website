          ...
          >
            <div className="flex flex-col justify-center items-start md:w-[350px] gap-3">
              ...
              <div className="flex justify-center items-center gap-3">
                <div className="w-[30px] h-[30px] rounded-[30px] flex justify-center items-center bg-[#F2613F]">
            ...
            >
              <h2 className="font-bold font-museo text-[20px]">
                Send a Message
              </h2>
              <form className="flex flex-col justify-center items-center gap-4 w-[260px] md:w-[300px]">
                ...
                <button className="flex items-center justify-center gap-1 rounded-[30px] hover:bg-[#a93c24] bg-[#F2613F] px-2 py-2 mt-3 lg:w-[80%] text-[12px] text-white font-museo font-bold">
                  Send Message
